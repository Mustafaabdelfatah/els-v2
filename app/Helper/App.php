...
if (!function_exists('userOrganization')) {
    function userOrganization(){
        return Auth::user()->organization_admin()->pluck('organization_id')->toArray();
    }
}
...
if (!function_exists('primarySlug')) {
    ...
    {
        return strtolower(str_replace([' ', '-'], '_', \App\Models\User::find(primaryID())->name)) ?? 'admin';
    }
}


define('COUNTRY_CODE', array
    (
        "AF" => "Afghanistan",
        "AL" => "Albania",
        "DZ" => "Algeria",

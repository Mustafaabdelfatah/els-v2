        ...
        <div class="offset-0 col-12 d-none d-lg-flex offset-md-1 col-lg h-lg-100">
          <div class="min-h-100 d-flex align-items-center">
            <div class="w-100 w-lg-75 w-xxl-50">
              <div>
                <div class="mb-5">
                  <h1 class="display-3 text-white">{{ $t('Legal_Department_System') }}</h1>
                </div>
                <p class="h6 text-white lh-1-5 mb-5">
                  {{ $t("Legal_Department_System_text_desc")}}
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="sw-lg-80 min-h-100 bg-foreground d-flex justify-content-center align-items-center shadow-deep py-5 full-page-content-right-border">
            <div class="sw-lg-60 px-5">
              ...
              <div class="mb-5">
                ...
                <h2 class="display-2 text-primary">{{ $t('Error_404') }}</h2>
              </div>
              <div class="mb-5">
              ...
              <div>
                <nuxt-link class="btn btn-icon btn-icon-start btn-primary"
                           :to="{name: 'home'}">

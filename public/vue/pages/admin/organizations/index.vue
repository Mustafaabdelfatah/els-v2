<template>
  <main>
    <div class="container">
      <div class="row">
        <div class="col">
                ...
                <div class="d-inline-block">
                  ...
                  >
                    ...
                    <div class="dropdown-menu shadow dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">All {{ $t("Rows") }}</a>
                    </div>
                  </div>
          ...
          >
            <organization-dialog :id="id" v-if="id>-1" v-on:resetID="resetID" />
    ...
    <delete-confirm url="admin/organizations" :id="ids" />
    <restore-dialog url="admin/organizations/restore" :id="ids" />
  </main>
</template>
  ...
  methods: {
    getOrganizations() {
      ...
      window.datatableServerSideUrl =
        this.$axios.defaults.baseURL + "admin/organizations";

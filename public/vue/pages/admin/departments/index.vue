<template>
  <main>
    <div class="container">
      <div class="row">
        <div class="col">
          ...
          >
            <department-dialog :id="id" v-if="id>-1" v-on:resetID="resetID"/>
    ...
    <delete-confirm url="admin/departments" :id="ids"/>
    <restore-dialog url="admin/departments/restore" :id="ids"/>
  </main>
</template>
  ...
  methods: {
    getDepartments() {
      ...
      window.datatableServerSideUrl =
        this.$axios.defaults.baseURL + "admin/departments";
